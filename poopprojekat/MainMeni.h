...
public:
	void IspisiMainMeni() {
		...
		std::cout << "5. Eksportovanje kompozitne funkcije" << std::endl;
		std::cout << "6. Brisanje odredjenog sloja" << std::endl; // TODO: uraditi: ucitavanje iz 24, pa ucitavanje iz 32 BMP probati rucno
		std::cout << "7. Ispis slike u zeljenom formatu" << std::endl;
